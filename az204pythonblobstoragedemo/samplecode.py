...
class PythonBlobLab(object):
    ...
    my_connection_string = "DefaultEndpointsProtocol=https;AccountName=pythonlab72vrx;AccountKey=jkLrTSbHigNJBAar0zcxVc1dazuhkWjjQQQDYYYNdJdRkhEv7ubWNUSLDWKQCboO8CxuS09c+8oH+ASt5aw+RA==;EndpointSuffix=core.windows.net"
