...
12. DEMO: Create a Web App in CLI
    ...
    - We just create a new directory in azure and clone the repo into it: `git clone https://github.com/Azure-Samples/html-docs-hello-world.git`
    - We can now create a new web app based on this resource: `az webapp up --location westeurope --name webappfromtemplate --html`